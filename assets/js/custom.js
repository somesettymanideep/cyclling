...
(function ($) {
	...
	///=============  * Circle Progress Bar  =============\\\
	jQuery(document).ready(function($) {
		$('.circle__progress-item').each(function() {
			var circle = $(this).find('.circle__progress-item-bar');
			var circlePercent = parseFloat(circle.attr('data-percent')) / 100;
